  ...
  return (
    <div ref={containerRef} className="relative w-full h-[600px] overflow-hidden flex justify-center cursor-grab active:cursor-grabbing">
      ...
      >
        ...
        <div className="w-full h-full bg-card rounded-[20px] border border-white/10 shadow-[0_0_50px_-10px_rgba(255,255,255,0.4)] overflow-hidden relative flex flex-col pointer-events-none select-none">
          {/* Header */}
          <div className="h-24 bg-gradient-to-br from-white to-primary flex items-center justify-center">
          </div>
          {/* Gantungan */}
          <div className="absolute top-3 left-1/2 -translate-x-1/2 w-16 h-4 bg-black/30 rounded-full blur-[1px]"></div>
          <div className="absolute top-[-10px] left-1/2 -translate-x-1/2 w-4 h-8 bg-card border border-white/20 rounded-full z-30"></div>
          {/* Foto */}
          ...
          <div className="text-center mt-4 px-4">
            ...
            <p className="text-xs text-muted font-mono mt-1">Informatics Student</p>
