...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-white/10 blur-[120px] rounded-full -z-10"></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        >
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 text-muted">
              <div className="p-3 bg-white/5 rounded-full border border-white/10 text-muted">
        ...
        <motion.div
          ...
          className="bg-card p-8 md:p-10 rounded-3xl border border-white/5 shadow-2xl relative"
        >
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-gray-400 transition placeholder:text-gray-600"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-gray-400 transition placeholder:text-gray-600 resize-none"
              ></textarea>
            </div>
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 transition-all duration-300 ${isSuccess
